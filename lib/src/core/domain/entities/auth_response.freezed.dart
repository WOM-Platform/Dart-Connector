...
abstract class $AuthResponseCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String token, bool verified});
}
...
class _$_AuthResponse implements _AuthResponse {
  const _$_AuthResponse(
      {required this.id, required this.token, required this.verified});
  ...
  @override
  String toString() {
    return 'AuthResponse(id: $id, token: $token, verified: $verified)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, token, verified);
...
abstract class _AuthResponse implements AuthResponse {
  const factory _AuthResponse(
      ...
      required final bool verified}) = _$_AuthResponse;
